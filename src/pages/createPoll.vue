    ...
    <div class="w-full h-screen flex justify-center  bg-gray-200">
        <form class="m-auto  flex flex-col w-2/5 bg-white   p-4">
            ...
            <input type="text" placeholder="enter title" v-model="newPoll.title"
                class="border-black border-2 rounded p-2 m-2 text-2xl ">
            <label class="text-2xl m-2">Options:</label>
            <div class="border-black flex border-2 rounded p-2 m-2 justify-between text-2xl ">
            ...
            <div>
                <div class="flex flex-wrap rounded m-2 w-5/5">
                    <span v-for="option in newPoll.options " :key="option.trim()">
                        <div class="border-black border-2 m-2 rounded p-1 bg-gray-200 ">
                            <span class="text-xl p-2">{{ option.trim() }}</span>
